function SFNS()
{
	SFNS.vinfo={time:'Sun Apr 24 20:36:47 UTC+0800 2011',version:'1.0',ov:'0.1.20080518'};
	...
	{
		if(typeof(params)!=_OBS_1[185]){params=[params]}
	...
	{
		obj.style.filter=_OBS_1[183]+parseInt(opacity*100)+")";
	 ...
	 function _OBS_17(div,rotate)
	{
		...
		var proName,typeName=_OBS_1[182];
		...
		if(typeof(style.filter)==_OBS_1[182] && document.body.filters)
		{
	 ...
	 function _OBS_19(src,config)
	{
		...
		if(config.spritePoint && (config.spriteSize || config.size))
		{
			...
			_OBS_4(img.style,{overflow:_OBS_1[181],display:'inline-block'});
			if(img.style.position!=_OBS_1[180]){img.style.position=_OBS_1[179];}
			...
			_OBS_4(spriteImg.style,{position:_OBS_1[180]});
	 ...
	 function _OBS_21(div,src,config)
	{
		...
		if(config.canPrint)
		{
			...
			if(config.spritePoint && config.imageSize)
			{
				...
				_OBS_4(img.style,{position:_OBS_1[179],border:'0px',width:(isHor?_OBS_1[178]:(config.imageSize[0]+"px")),height:(isVer?_OBS_1[178]:(config.imageSize[1]+"px")),left:(isHor?(100*config.spritePoint[0]/config.imageSize[0]+'%'):(-config.spritePoint[0]+"px")),top:(isVer?(100*config.spritePoint[1]/config.imageSize[1]+'%'):(-config.spritePoint[1]+"px")),zIndex:-1});
				sizeDiv.appendChild(img);
			}
			_OBS_4(sizeDiv.style,{position:_OBS_1[180],border:'0px',width:_OBS_1[178],height:_OBS_1[178],left:'0px',top:'0px',zIndex:-1,overflow:_OBS_1[181]});
		...
		if(config.spriteDouble)
		{
			...
			_OBS_4(bar.style,{position:_OBS_1[180],fontSize:'0px',left:'0px',top:'0px',width:_OBS_1[178],height:_OBS_1[178],overflow:_OBS_1[181]});
	 ...
	 function _OBS_31(obj,event,handle,once)
	{
		...
		if(obj[_OBS_1[176]+event] && type!="shape")
		{
			obj[_OBS_1[176]+event].push(listener);
		}
		else
		{
			obj[_OBS_1[176]+event]=(type=="shape")?[]:[listener];
		}
	 ...
	 function _OBS_32(listener)
	{
		...
		_OBS_14(listener[0][_OBS_1[176]+listener[1]],listener);
	 ...
	 function _OBS_33(obj,event)
	{
		...
		var listener,listeners=obj[_OBS_1[176]+event];
	 ...
	 function _OBS_35(obj,event,args)
	{
		...
		if(!args){args=[];}
		var listeners=obj[_OBS_1[176]+event];
	...
	{
		if(typeof e.clientX!=_OBS_1[175])
		{
			var rect = container.getBoundingClientRect(); 
			return [e.clientX-rect.left, e.clientY-rect.top] 
		}
		
		if(typeof e.pageX!=_OBS_1[175])
		{
	 ...
	 function _OBS_43()
	{
		...
		else if(typeof(ActiveXObject)!=_OBS_1[175])
		{
	...
	{
		var doc;
		if(typeof(ActiveXObject)!=_OBS_1[175]&&typeof(window.GetObject)!=_OBS_1[175])
		{
		...
		else
		{
			if(xmlStr)
			{
				if(typeof DOMParser!=_OBS_1[175])	
				{
	...
	{
		if(!node || typeof(node)!=_OBS_1[185]){return node;}
	...
	_OBS_4(SFConfig.prototype,{getConfig: function(path,dv)
	{
		...
		return typeof(obj)!=_OBS_1[175]?obj:dv
	},getConfigObj: function(path)
	{
		...
		while(typeof(name=paths.shift())==_OBS_1[182])
		{
			if(!name){continue;}
			if(!obj || typeof(obj)!=_OBS_1[185]){break;}
			obj=obj[name];
		}
		return obj;
	},setConfig: function(path,value,cover)
	{
		...
		while(name=paths.shift())
		{
			if(paths[0])
			{
				if(!obj[name] || typeof(obj[name])!=_OBS_1[185])
				{
					obj[name]={};
				}
				obj=obj[name];
	 ...
	 function _OBS_53(obj,json)
	{
		...
		for(var key in json)
		{
			if(typeof(json[key])==_OBS_1[177]){continue;}
			obj[key]=json[key];
		}
	}
	...
	_OBS_4(SFDragObject.prototype,{onMouseDown: function(e)
	{
		...
		_OBS_4(this,{
			ml:_OBS_28(doc,_OBS_1[172],this,this.onMouseMove),
			ul:_OBS_28(doc,_OBS_1[171],this,this.onMouseUp),
			sp:point,
			lp:point,
		...
		this.handle(point,point,_OBS_1[170]);
	...
	{
		return _OBS_31(div,_OBS_1[173],function(e)
		{
	...
	{
		_OBS_4(this.div.style,{position:_OBS_1[180],left:position.x+"px",top:position.y+"px"});
	 ...
	 function SFGraphicsCanvas()
	{
		...
		_OBS_4(div.style,{position:_OBS_1[180],zIndex:420});
	}
	...
	},setLineWeight: function(weight)
	{
	 ...
	 function _OBS_60()
	{
		if(typeof(SFGraphicsCanvas._isSupport)==_OBS_1[175])
		{
	...
	},setOpacity: function(opacity)
	{
		_OBS_4(this.div.style,{
			filter:_OBS_1[183]+parseInt(opacity*100)+")",
			MozOpacity:opacity,
			opacity:opacity
		});
	},setLineWeight: function(weight)
	...
	},reDraw: function()
	{
		...
		for(var i=0;i<pathArr.length;i++)
		{
			...
			if(this.lineColor)
			{
				...
				ctx.setStroke((this.lineStyle && this.lineStyle!=_OBS_1[168] && window.Stroke)?window.Stroke.DOTTED:this.lineWeight);
	...
	},clear: function(){this.path.setAttribute("d","");},setScale: function(scale)
	{
		...
		this.lastScale=scale;
		this.path.setAttribute(_OBS_1[166],this.getStyle());
	},setPosition: function(position)
	{
		if(!position){return;}
		this.lastPosition=position;
		var lineWeight=this.lineWeight;
		_OBS_4(this.div.style,{position:_OBS_1[180],left:(position.x-lineWeight)+"px",top:(position.y-lineWeight)+"px"});
	},setLineColor: function(color)
	{
		if(color==_OBS_1[169] || !color){color=_OBS_1[165]}
		this.lineColor=color;
		this.path.setAttribute(_OBS_1[166],this.getStyle());
	},setFillColor: function(color)
	{
	...
	},getStyle: function()
	{
	 ...
	 function _OBS_62()
	{
		if(typeof(SFGraphicsSvg._isSupport)==_OBS_1[175])
		{
			if(document.createElementNS)
			{
				var svgNs=_OBS_1[167];
				var div=document.createElementNS(svgNs,'svg');
				SFGraphicsSvg._isSupport=typeof(div.ownerSVGElement)==_OBS_1[185];
			}
			else
			{
	 ...
	 function SFGraphicsVml()
	{
		...
		stroke.style.cssText=fill.style.cssText=div.style.cssText=_OBS_1[163];
		stroke.style.behavior=fill.style.behavior=div.style.behavior=_OBS_1[162];
		div.style.position=_OBS_1[180];
	...
	{
		this.div.style.display=_OBS_1[165]
		this.div.path="e";
	 ...
	 function _OBS_63()
	{
		...
		if(typeof(SFGraphicsVml._isSupport)==_OBS_1[175])
		{
			...
			try{
				...
				if(document.namespaces)
				{
					...
					div.style.cssText=_OBS_1[163]
					div.style.behavior=_OBS_1[162]
					document.body.appendChild(div);
					
					SFGraphicsVml._isSupport=typeof(div.Path)==_OBS_1[185];
	...
	{
		this.addTreeModule(_OBS_1[161]);
		this.addTreeModule(_OBS_1[160]);
		this.addModule(_OBS_1[159]);
		...
		this.addLink=function(sucTask,preTask,type)
		{
			...
			if(!this.checkEvent(_OBS_1[157],[sucTask,preTask,type])){return false;}
		...
		_OBS_28(this,_OBS_1[155],this,function(link)
		{
		...
		_OBS_28(this,_OBS_1[157],this,function(returnObj,sucTask,preTask)
		{
	...
	},addModule: function(type)
	{
		...
		this[_OBS_1[153]+type]=function(element,property,value){return this.updateElement(type,element,property,value);}
		this[_OBS_1[152]+type]=function(element){return this.registerElement(type,element);}
		this[_OBS_1[151]+type]=function(element){return this.unregisterElement(type,element);}
		this["add"+type]=function(){var argu=[type];for(var i=0;i<arguments.length;i++){argu.push(arguments[i]);}return this.addElement(argu);}
		this["canAdd"+type]=function(){return this.checkEvent(_OBS_1[150]+type+"add",arguments);}
		this[_OBS_1[149]+type]=function(element){return this.deleteElement(type,element);}
		this["canDelete"+type]=function(){return this.checkEvent(_OBS_1[150]+type+_OBS_1[149],arguments);}
	},addTreeModule: function(type)
	{
		this.addModule(type);
		this[_OBS_1[148]+type]=function(item){return this.getRootElement(type);}
		this["read"+type+_OBS_1[147]]=function(item){return this.readElementFirstChild(type,item);}
		this["read"+type+_OBS_1[146]]=function(item){return this.readElementNextSibling(type,item);}
		...
		this[_OBS_1[151]+type]=function(element){return this.unregisterTreeElement(type,element);}
		this["add"+type]=function(parent,pElement){return this.addTreeElement(type,parent,pElement);}
		this[_OBS_1[149]+type]=function(element){return this.deleteTreeElement(type,element);}
		this[_OBS_1[145]+type]=function(element,pElement,preElement){return this.moveElement(type,element,pElement,preElement);}
	...
	},registerElement: function(type,item)
	{
		...
		_OBS_35(this,type.toLowerCase()+_OBS_1[152],[item]);
	...
	},addElement: function(type)
	{
		...
		if(!this.checkEvent(_OBS_1[150]+type.toLowerCase()+"add",argu)){return false;}
		var newElement=this.adapter["add"+type].apply(this.adapter,argu);
		
		
		_OBS_35(this,_OBS_1[144]+type.toLowerCase()+"add",[newElement]);
	...
	},deleteElement: function(type,element)
	{
		...
		if(!this.checkEvent(_OBS_1[150]+type.toLowerCase()+_OBS_1[149],[element])){return false;}
		this.unregisterElement(type,element);
		this.adapter[_OBS_1[149]+type](element);
		
		
		_OBS_35(this,_OBS_1[144]+type.toLowerCase()+_OBS_1[149],[element]);
		return true;
	...
	},readElementFirstChild: function(type,element)
	{
		...
		{
			var t=element.firstChild=this.adapter["read"+type+_OBS_1[147]](element);
			if(t)
			{
				t.parent=element;
	...
	},readElementNextSibling: function(type,element)
	{
		...
		{
			var t=element.nextSibling=this.adapter["read"+type+_OBS_1[146]](element);
			if(t)
			{
	...
	{
		this.adapter[_OBS_1[153]+type](element,property,value);
	},addTreeElement: function(type,parent,pElement)
	{
		...
		if(!this.checkEvent(_OBS_1[150]+type.toLowerCase()+"add",[parent,pElement])){return false;}
		if(!parent.getFirstChild())
		{
			parent.setProperty(_OBS_1[143],true);
		}
	...
	},deleteTreeElement: function(type,element)
	{
		...
		if(parent)
		{
			...
			parent.setProperty(_OBS_1[143],!!parent.getFirstChild());
		}
		...
		_OBS_35(this,_OBS_1[144]+type.toLowerCase()+_OBS_1[149],[element,parent,pt]);
		return true;
	...
	},moveElement: function(type,element,pElement,preElement)
	{
		...
		if(parent.getFirstChild()==element)
		{
			...
			if(!nextSibling){parent.setProperty(_OBS_1[143],false);}
		}
		element.parent=null;
		if(previousSibling)
		{
		...
		pElement.setProperty(_OBS_1[143],true);
		this.adapter[_OBS_1[145]+type](element,parent,previousSibling);
		
		
		_OBS_35(this,_OBS_1[144]+type.toLowerCase()+_OBS_1[145],[element,parent,previousSibling]);
		return true;
	},canMoveElement: function(type,element,pElement,preElement)
	{
		...
		if(!this.checkEvent(_OBS_1[150]+type.toLowerCase()+_OBS_1[145],[element,pElement,preElement])){return false;}
		return true;
	}});
	...
	{
		var a=(typeof(this[name])==_OBS_1[185] && value)?this[name].valueOf():this[name];
		var b=(typeof(value)==_OBS_1[185] && value)?value.valueOf():value;
		if(a==b){return true;}
		if(!this.canSetProperty(name,value)){return false;}
		var beforeValue=this[name];
		this[name]=value;
		if(!this.data){return true}
		if(this.data[_OBS_1[153]+this.elementType]){this.data[_OBS_1[153]+this.elementType](this,name,value);}
		...
		_OBS_35(this.data,_OBS_1[144]+this.elementType.toLowerCase()+_OBS_1[142],[this,name,value,beforeValue]);
		var bp={},ap={};
		bp[name]=beforeValue;
		ap[name]=value
		...
		_OBS_35(this.data,_OBS_1[144]+this.elementType.toLowerCase()+_OBS_1[153],[this,[name],ap,bp]);
		return true;
	},canSetProperty: function(name,value)
	{
		...
		return this.data.checkEvent(_OBS_1[150]+this.elementType.toLowerCase()+_OBS_1[142],[this,name,value]);
	}});
	...
	{
		if(typeof(this.firstChild)==_OBS_1[175])
		{
	...
	{
		if(typeof(this.nextSibling)==_OBS_1[175])
		{
	...
	},update: function(){},checkTime: function()
	{
		...
		{
			this.setProperty(_OBS_1[141],this.Start);
		}
		else
		{
			this.setProperty(_OBS_1[140],new Date(startDate));
			this.setProperty(_OBS_1[141],new Date(Math.max(startDate,endDate)));
		}
	...
	},addAssignment: function(resource,unit)
	{
		...
		if(!am){return;}
		if(unit){am.setProperty(_OBS_1[139],unit);}
		return am;
	}});
	 function SFDataLink()
	{
	...
	},addDefaultProperty: function()
	{
		...
		this.addTaskProperty(_OBS_1[138],	0,			renderType.String);
		
		this.addTaskProperty(_OBS_1[137],	0,			renderType.Int);
		
		this.addTaskProperty(_OBS_1[140],		0,			renderType.Time);
		
		this.addTaskProperty(_OBS_1[141],		0,			renderType.Time);
		
		this.addTaskProperty('Name',		0,			renderType.String);
		
		this.addTaskProperty(_OBS_1[136],	0,			renderType.Bool2Int);


		
		this.addTaskProperty(_OBS_1[135],	0,			renderType.Int);
		
		this.addTaskProperty(_OBS_1[134],		0,			renderType.String);
		
		this.addTaskProperty(_OBS_1[133],	0,			renderType.Int);
		
		this.addTaskProperty(_OBS_1[132],	0,			renderType.Time);
		...
		this.addTaskProperty(_OBS_1[129],	0,			renderType.String);
		
		this.addTaskProperty(_OBS_1[128],	0,			renderType.Bool2Int);
		
		this.addTaskProperty(_OBS_1[127],	0,			renderType.Int);
		
		this.addTaskProperty(_OBS_1[126],	0,			renderType.Bool2Int);


		
		this.addTaskProperty(_OBS_1[125],	'Baseline/Start',	renderType.Time);
		
		this.addTaskProperty(_OBS_1[124],	'Baseline/Finish',	renderType.Time);
		...
		this.addResourceProperty(_OBS_1[128],	0,			renderType.Bool2Int);
		
		this.addResourceProperty('Name',	0,			renderType.String);
		
		this.addResourceProperty('ID',		0,			renderType.Int);
		
		this.addResourceProperty(_OBS_1[138],0,			renderType.String);
		
		this.addResourceProperty(_OBS_1[137],0,			renderType.Int);
		
		this.addResourceProperty(_OBS_1[136],	0,			renderType.Bool2Int);
		
		this.addResourceProperty(_OBS_1[134],	0,			renderType.String);


		
		this.addLinkProperty("UID",		0,			renderType.String);
		
		this.addLinkProperty(_OBS_1[123],	0,			renderType.String);
		
		this.addLinkProperty(_OBS_1[122],	0,			renderType.String);
		
		this.addLinkProperty(_OBS_1[121],		0,			renderType.Int);


		
		this.addAssignmentProperty("UID",	0,			renderType.String);
		
		this.addAssignmentProperty(_OBS_1[120],	0,			renderType.String);
		
		this.addAssignmentProperty(_OBS_1[119],0,			renderType.String);
		
		this.addAssignmentProperty(_OBS_1[139],	0,			renderType.Float);
	...
	},readTaskLink: function(task,node)
	{
		...
		link[node.nodeName==_OBS_1[116]?_OBS_1[115]:_OBS_1[114]]=task;
		return link;
	...
	},updateItem: function(writer,item,proName,value)
	{
		...
		if(!writer[proName] && this.extendedAttributes && this.extendedAttributes[proName])
		{
			...
			{
				if(child.nodeName!=_OBS_1[117]){continue;}
				var idNode=_OBS_46(child,_OBS_1[118]);
			...
			var child=item.node.ownerDocument.createElement(_OBS_1[117]);
			var idNode=child.ownerDocument.createElement(_OBS_1[118]);
	 ...
	 function SFDataXml(url,config)
	{
		...
		var doc=(typeof(url)==_OBS_1[182])?this.loadUrl(url):url;
		config=config?config:new SFConfig();
	...
	{
		var calId;
		var node=_OBS_46(this.doc.documentElement,_OBS_1[112]);
		if(node)
		{
			calId=_OBS_47(node);
		...
		return _OBS_56(_OBS_1[174]);
	},readRootTask: function()
	{
		var rootTaskNode=_OBS_46(this.doc.documentElement,_OBS_1[161]);
		if(!rootTaskNode)
		{
	...
	},readTaskFirstChild: function(task)
	{
		...
		if(task.node.getAttribute(_OBS_1[111]))
		{
			var doc=this.loadUrl(task.node.getAttribute(_OBS_1[111]));
			task.node.removeAttribute(_OBS_1[111]);
			var tasksNode=_OBS_46(task.node,_OBS_1[110]);
			if(!tasksNode)
			{
				tasksNode=task.node.ownerDocument.createElement(_OBS_1[110]);
	...
	{
		if(!task.node){return null;}
		if(task.node.getAttribute(_OBS_1[109]))
		{
			var doc=this.loadUrl(task.node.getAttribute(_OBS_1[109]));
			task.node.removeAttribute(_OBS_1[109]);
			var tasksNode=_OBS_46(task.getParentTask().node,_OBS_1[110]);
			while(doc.documentElement.firstChild)
			{
				var taskNode=doc.documentElement.firstChild;
				doc.documentElement.removeChild(taskNode);
		...
		return this.readTask(_OBS_50(task.node.nextSibling,_OBS_1[161]));
	},readRootResource: function()
	{
		var rootResourceNode=_OBS_46(this.doc.documentElement,_OBS_1[160]);
		if(!rootResourceNode)
		{
	...
	},readResourceFirstChild: function(resource)
	{
		...
		if(resource.node.getAttribute(_OBS_1[111]))
		{
			var doc=this.loadUrl(resource.node.getAttribute(_OBS_1[111]));
			resource.node.removeAttribute(_OBS_1[111]);
			var resourcesNode=_OBS_46(resource.node,_OBS_1[108]);
			if(!resourcesNode)
			{
				resourcesNode=resource.node.ownerDocument.createElement(_OBS_1[108]);
	...
	{
		if(!resource.node){return null;}
		if(resource.node.getAttribute(_OBS_1[109]))
		{
			var doc=this.loadUrl(resource.node.getAttribute(_OBS_1[109]));
			resource.node.removeAttribute(_OBS_1[109]);
			var resourcesNode=_OBS_46(resource.getParentResource().node,_OBS_1[108]);
			while(doc.documentElement.firstChild)
			{
				var resourceNode=doc.documentElement.firstChild;
				doc.documentElement.removeChild(resourceNode);
		...
		return this.readResource(_OBS_50(resource.node.nextSibling,_OBS_1[160]));
	},readTaskFirstLink: function(task)
	{
		var node,taskNode=task.node;
		if(!taskNode){return null;}
		for(node=taskNode.firstChild;node;node=node.nextSibling){if(node.nodeName==_OBS_1[116] || node.nodeName==_OBS_1[107]){break;}}
	...
	},readTaskNextLink: function(task,link)
	{
		...
		for(node=linkNode.nextSibling;node;node=node.nextSibling){if(node.nodeName==_OBS_1[116] || node.nodeName==_OBS_1[107]){break;}}
		if(!node && linkNode.parentNode.nodeName!="Links")
		{
			node=_OBS_46(linkNode,_OBS_1[106]);
		}
		return this.readTaskLink(task,node);
	},readTaskFirstAssignment: function(task)
	{
		if(!task.node){return null;}
		return this.readTaskAssignment(task,_OBS_46(task.node,_OBS_1[105]));
	},readTaskNextAssignment: function(task,assignment)
	{
		if(!assignment.node){return null;}
		return this.readTaskAssignment(task,_OBS_50(assignment.node.nextSibling,_OBS_1[158]))
	},readResourceFirstAssignment: function(resource)
	{
		if(!resource.node){return null;}
		return this.readTaskAssignment(resource,_OBS_46(resource.node,_OBS_1[105]));
	},readResourceNextAssignment: function(resource,assignment)
	{
		if(!assignment.node){return null;}
		return this.readTaskAssignment(resource,_OBS_50(assignment.node.nextSibling,_OBS_1[158]))
	...
	},addTask: function(parent,pTask)
	{
		...
		if(this.saveChange)
		{
			var node=parent.node.ownerDocument.createElement(_OBS_1[161]);
			this.insertNode(node,parent,pTask,_OBS_1[110]);
			task.node=node;
		}
		return task;
	...
	},moveTask: function(task,parentTask,pTask)
	{
		if(!this.saveChange){return;}
		task.node.parentNode.removeChild(task.node);
		this.insertNode(task.node,parentTask,pTask,_OBS_1[110]);
	},addResource: function(parent,pResource)
	{
		...
		if(this.saveChange)
		{
			...
			this.insertNode(node,parent,pResource,_OBS_1[108]);
			resource.node=node;
		}
		return resource;
	...
	},moveResource: function(resource,parentResource,pResource)
	{
		if(!this.saveChange){return;}
		resource.node.parentNode.removeChild(resource.node);
		this.insertNode(resource.node,parentResource,pResource,_OBS_1[108]);
	},addLink: function(selfTask,preTask,type)
	{
		...
		if(this.saveChange)
		{
			...
			var node=doc.createElement(_OBS_1[116]);
			var child=doc.createElement(_OBS_1[123]);
			_OBS_48(child,preTask.UID);
			node.appendChild(child);
			var child=doc.createElement(_OBS_1[121]);
			_OBS_48(child,type);
			node.appendChild(child);
			link.node=node;
			link.setProperty(_OBS_1[121],type);
	...
	},addAssignment: function(task,resource,units)
	{
		...
		{
			var doc=this.doc;
			var node=doc.createElement(_OBS_1[158]);
			...
			node.appendChild(child);
			var child=doc.createElement(_OBS_1[139]);
			_OBS_48(child,units);
			node.appendChild(child);
			assignment.node=node;
			var assignmentsNode=_OBS_46(task.node,_OBS_1[104]);
			if(!assignmentsNode)
			{
				assignmentsNode=task.node.ownerDocument.createElement(_OBS_1[104]);
	...
	},getTasksNode: function()
	{
		...
		if(!this.tasksNode)
		{
			this.tasksNode=this.doc.createElement(_OBS_1[110]);
	...
	},getResourcesNode: function()
	{
		...
		{
			this.resourcesNode=this.doc.createElement(_OBS_1[108]);
	...
	},getAssignmentsNode: function()
	{
		...
		{
			this.assignmentsNode=this.doc.createElement(_OBS_1[104]);
			this.doc.documentElement.appendChild(this.assignmentsNode);
		}
		return this.assignmentsNode;
	},readRootTask: function()
	{
		var rootTaskNode=_OBS_50(this.getTasksNode().firstChild,_OBS_1[161]);
		if(!rootTaskNode)
		{
			var task=this.addTask();
			return task;
	...
	},readTaskFirstChild: function(task)
	{
		...
		var node=_OBS_50(task.node.nextSibling,_OBS_1[161]);
		if(node)
		{
			var level=_OBS_46(node,_OBS_1[137])?_OBS_47(_OBS_46(node,_OBS_1[137])):_OBS_47(_OBS_46(node,_OBS_1[138])).split(".").length;
			if(level>selfLevel)
			{
	...
	},readTaskNextSibling: function(task)
	{
		...
		{
			if(node.nodeName!=_OBS_1[161]){continue;}
	...
	{
	     if(!resource.node){return null;}
		if(resource.node!=_OBS_50(this.getResourcesNode().firstChild,_OBS_1[160])){return null;}
		return this.readResource(_OBS_50(resource.node.nextSibling,_OBS_1[160]));
	},readResourceNextSibling: function(resource)
	{
	    if(!resource.node){return null;}
	...
	},readTaskFirstAssignment: function(task)
	{
		...
		{
			if(node.nodeName!=_OBS_1[158]){continue;}
			if(_OBS_47(_OBS_46(node,_OBS_1[120]))==uid)
			{
	...
	},addTask: function(parent,pTask)
	{
		...
		if(this.saveChange)
		{
			...
			var node=tasksNode.ownerDocument.createElement(_OBS_1[161]);
			if(parent)
			{
	...
	},addResource: function(parent,pResource)
	{
		...
		if(this.saveChange)
		{
			...
			var node=resourcesNode.ownerDocument.createElement(_OBS_1[160]);
	...
	},addAssignment: function(task,resource,units)
	{
		...
		if(this.saveChange)
		{
			...
			if(units)
			{
				...
				_OBS_48(child,units);
				node.appendChild(child);
				assignment.setProperty(_OBS_1[139],units);
			}
			assignment.node=node;
	...
	_OBS_4(SFDataCalculateTimeComponent.prototype,{initialize: function(data)
	{
		...
		this.listeners=[
			_OBS_28(data,_OBS_1[103],this,this.onTaskChange),
			_OBS_28(data,_OBS_1[102],this,this.onTaskDelete),
			_OBS_28(data,_OBS_1[101],this,this.onTaskMove)
		];
		return true;
	},onTaskChange: function(task,name,value)
	{
		if(name!=_OBS_1[140] && name!=_OBS_1[141]){return;}
	...
	_OBS_4(SFDataOutlineComponent.prototype,{initialize: function(data)
	{
		...
		{
			if(!data[_OBS_1[148]+modules[i]]){continue;}
			var module=modules[i].toLowerCase();
			this.listeners=this.listeners.concat(
				[
					_OBS_28(data,module+_OBS_1[152],this,this.onElementRegister),
					_OBS_28(data,_OBS_1[144]+module+"add",this,this.onElementAdd),
					_OBS_28(data,_OBS_1[144]+module+_OBS_1[149],this,this.onElementDelete),
					_OBS_28(data,_OBS_1[144]+module+_OBS_1[145],this,this.onElementMove)
				]
			);
		}
	},setOutline: function(element,toChild)
	{
		...
		var changed=(number!=element[_OBS_1[138]]);
		element.setProperty(_OBS_1[138],number);
		element.setProperty(_OBS_1[137],level);
	...
	_OBS_4(SFDataReadOnlyComponent.prototype,{initialize: function(data)
	{
		...
		for(var i=modules.length-1;i>=0;i--)
		{
			...
			this.listeners=this.listeners.concat(
				[
					_OBS_28(data,_OBS_1[150]+module+_OBS_1[142],this,this.onElementChange),
					_OBS_28(data,_OBS_1[150]+module+_OBS_1[149],this,this.onElementAction),
					_OBS_28(data,_OBS_1[150]+module+_OBS_1[145],this,this.onElementAction)
				]
			);
		}
		return true;
	},onElementChange: function(returnObj,element,name)
	{
		...
		if(element[_OBS_1[136]]){returnObj.returnValue=false;}
	...
	},start: function(data)
	{
		this.stop();
		this.listeners=[
			_OBS_28(data,_OBS_1[100],this,this.onTaskAdd),
			_OBS_28(data,_OBS_1[102],this,this.onTaskDelete),
			_OBS_28(data,_OBS_1[101],this,this.onTaskMove),
			_OBS_28(data,_OBS_1[103],this,this.onTaskChange),

			_OBS_28(data,_OBS_1[156],this,this.onLinkAdd),
			_OBS_28(data,"afterlinkdelete",this,this.onLinkDelete),
			_OBS_28(data,_OBS_1[99],this,this.onLinkChange)
			];
	},clear: function()
	{
		_OBS_4(this,{
	...
	},getXml: function()
	{
		...
		if(elements && elements.length>0)
		{
			...
			for(var i=0;i<elements.length;i++)
			{
				...
				var elementNode=this.addNode(groupNode,_OBS_1[161]);
				...
				if(element.task.getPreviousSibling()){this.addNode(elementNode,_OBS_1[98],element.task.getPreviousSibling().UID);}
			}
		}
		...
		if(elements && elements.length>0)
		{
			...
			for(var i=0;i<elements.length;i++)
			{
				...
				var elementNode=this.addNode(groupNode,_OBS_1[159]);
				this.addPropertyNode(elementNode,element.link,["UID",_OBS_1[121]]);
				
				this.addPropertyNode(elementNode,element.link,element.fields);
				if(element.link.getPredecessorTask()){this.addNode(elementNode,_OBS_1[123],element.link.getPredecessorTask().UID);}
				if(element.link.getSuccessorTask()){this.addNode(elementNode,_OBS_1[122],element.link.getSuccessorTask().UID);}
			}
		}
	...
	{
		this.taskFields=typeof(fields)==_OBS_1[182]?fields.split(","):fields;
	...
	{
		this.linkFields=typeof(fields)==_OBS_1[182]?fields.split(","):fields;
	 ...
	 function SFGantt(gConfig,data)
	{
		...
		this.addControl(new SFGanttFieldList(this[this.elementType.toLowerCase()+_OBS_1[97]].split(",")));
		...
		this.addControl(elementList=new SFGanttElementList({fieldNames:this[this.elementType.toLowerCase()+_OBS_1[97]].split(","),bgColor:this.bodyBgColor,elementType:this.elementType}));
	...
	_OBS_4(SFGantt.prototype,{initContainer: function()
	{
		...
		this.container=container=(typeof(container)==_OBS_1[185])?container:document.getElementById(container);
		var child,doc=this.container.ownerDocument;
		
		try{doc.execCommand("BackgroundImageCache", false, true);}catch(e){}
		
		var style=this.container.style;
		if(style.position!=_OBS_1[180]){style.position=_OBS_1[179];}
		_OBS_4(style,{padding:'0px',margin:'0px',textAlign:_OBS_1[96],overflow:_OBS_1[181],backgroundColor:this.bodyBgColor,fontSize:this.fontSize+"px"});
	...
	},setViewSize: function(size)
	{
		...
		_OBS_35(this,_OBS_1[94],[returnObj,size]);
		if(!returnObj.returnValue){return false;}
		this.viewSize=size;
		
		_OBS_35(this,_OBS_1[93],[size]);
		return true;
	 ...
	 function SFGanttImageControl()
	{
		...
		this.images={
			...
			map_mask:{size:[4,2]},
			scroll_barbg:{sprite:_OBS_1[92],spritePoint:[0,51],spriteSize:[48,17]},
			scroll_barright:{sprite:_OBS_1[92],spritePoint:[28,0],spriteSize:[3,17]},
			scroll_barcenter:{sprite:_OBS_1[92],spritePoint:[20,0],spriteSize:[8,17]},
			scroll_barleft:{sprite:_OBS_1[92],spritePoint:[17,0],spriteSize:[3,17]},
			scroll_barbg1:{sprite:_OBS_1[92],spritePoint:[0,34],spriteSize:[48,17]},
			scroll_barright1:{sprite:_OBS_1[92],spritePoint:[28,17],spriteSize:[3,17]},
			scroll_barcenter1:{sprite:_OBS_1[92],spritePoint:[20,17],spriteSize:[8,17]},
			scroll_barleft1:{sprite:_OBS_1[92],spritePoint:[17,17],spriteSize:[3,17]},
			scroll_left:{sprite:_OBS_1[92],spritePoint:[0,0],spriteSize:[17,17]},
			scroll_right:{sprite:_OBS_1[92],spritePoint:[31,0],spriteSize:[17,17]},
			scroll_left1:{sprite:_OBS_1[92],spritePoint:[0,17],spriteSize:[17,17]},
			scroll_right1:{sprite:_OBS_1[92],spritePoint:[31,17],spriteSize:[17,17]},
			scroll_bg:{sprite:_OBS_1[92],spritePoint:[0,68],spriteSize:[48,18]},
			dragflag_right:{size:[3,21]},
			dragflag_left:{size:[2,21]},
			logo:{size:[36,36]},
			task_head_1:{sprite:_OBS_1[91],spritePoint:[0,0],spriteSize:[11,11]},
			task_head_2:{sprite:_OBS_1[91],spritePoint:[12,0],spriteSize:[11,11]},
			task_head_3:{sprite:_OBS_1[91],spritePoint:[24,0],spriteSize:[11,11]},
			task_head_3_hollow:{sprite:_OBS_1[91],spritePoint:[0,12],spriteSize:[11,11]},
			task_head_4:{sprite:_OBS_1[91],spritePoint:[12,12],spriteSize:[11,11]},
			task_head_5:{sprite:_OBS_1[91],spritePoint:[24,12],spriteSize:[11,11]},
			task_head_6:{sprite:_OBS_1[91],spritePoint:[0,24],spriteSize:[11,11]},
			task_head_7:{sprite:_OBS_1[91],spritePoint:[12,24],spriteSize:[11,11]},
			task_head_8:{sprite:_OBS_1[91],spritePoint:[24,24],spriteSize:[11,11]},
			task_head_9:{sprite:_OBS_1[91],spritePoint:[0,36],spriteSize:[11,11]},
			task_head_10:{sprite:_OBS_1[91],spritePoint:[12,36],spriteSize:[11,11]},
			task_head_11:{sprite:_OBS_1[91],spritePoint:[24,36],spriteSize:[11,11]},
			task_head_12:{sprite:_OBS_1[91],spritePoint:[0,48],spriteSize:[11,11]},
			task_head_13:{sprite:_OBS_1[91],spritePoint:[12,48],spriteSize:[11,11]},
			task_head_14:{sprite:_OBS_1[91],spritePoint:[24,48],spriteSize:[11,11]},
			task_head_15:{sprite:_OBS_1[91],spritePoint:[0,60],spriteSize:[11,11]},
			task_head_16:{sprite:_OBS_1[91],spritePoint:[12,60],spriteSize:[11,11]},
			task_head_17:{sprite:_OBS_1[91],spritePoint:[24,60],spriteSize:[11,11]},
			task_head_18:{sprite:_OBS_1[91],spritePoint:[0,72],spriteSize:[11,11]},
			task_head_19:{sprite:_OBS_1[91],spritePoint:[12,72],spriteSize:[11,11]},
			task_head_19_hollow:{sprite:_OBS_1[91],spritePoint:[24,72],spriteSize:[11,11]},
			task_head_20:{sprite:_OBS_1[91],spritePoint:[0,84],spriteSize:[11,11]},
			arrow_down:{sprite:_OBS_1[91],spritePoint:[13,84],spriteSize:[9,5]},
			arrow_left:{sprite:_OBS_1[91],spritePoint:[24,85],spriteSize:[5,9]},
			arrow_right:{sprite:_OBS_1[91],spritePoint:[30,85],spriteSize:[5,9]},
			arrow_up:{sprite:_OBS_1[91],spritePoint:[13,90],spriteSize:[9,5]},
			grid_1:{sprite:_OBS_1[91],spritePoint:[0,96],spriteSize:[36,36]},
			grid_2:{sprite:_OBS_1[91],spritePoint:[0,132],spriteSize:[36,36]},
			icon_finished:{sprite:_OBS_1[90],spritePoint:[0,16],spriteSize:[16,16]},
			icon_constraint2:{sprite:_OBS_1[90],spritePoint:[0,0],spriteSize:[16,16]},
			icon_constraint3:{sprite:_OBS_1[90],spritePoint:[16,0],spriteSize:[16,16]},
			icon_constraint4:{sprite:_OBS_1[90],spritePoint:[32,0],spriteSize:[16,16]},
			icon_constraint5:{sprite:_OBS_1[90],spritePoint:[48,0],spriteSize:[16,16]},
			icon_constraint6:{sprite:_OBS_1[90],spritePoint:[64,0],spriteSize:[16,16]},
			icon_constraint7:{sprite:_OBS_1[90],spritePoint:[80,0],spriteSize:[16,16]},
			icon_notes:{sprite:_OBS_1[90],spritePoint:[32,16],spriteSize:[16,16]},
			icon_hyperlink:{sprite:_OBS_1[90],spritePoint:[16,16],spriteSize:[16,16]},
			icon_taskstatus:{sprite:_OBS_1[90],spritePoint:[112,16],spriteSize:[16,16]},
			icon_taskinfo:{sprite:_OBS_1[90],spritePoint:[80,16],spriteSize:[16,16]},
			icon_taskgoto:{sprite:_OBS_1[90],spritePoint:[64,16],spriteSize:[16,16]},
			icon_print:{sprite:_OBS_1[90],spritePoint:[48,16],spriteSize:[16,16]},
			icon_zoomin:{sprite:_OBS_1[90],spritePoint:[0,32],spriteSize:[16,16]},
			icon_zoomout:{sprite:_OBS_1[90],spritePoint:[16,32],spriteSize:[16,16]},
			resize:{sprite:_OBS_1[90],spritePoint:[32,32],spriteSize:[16,16]}
		};
	}
	...
	_OBS_4(SFGanttAutoResizeControl.prototype,{initialize: function(gantt)
	{
		...
		this.gantt=gantt;
		this.listeners=[
			_OBS_28(gantt.getContainer(),_OBS_1[88],this,this.onResize),
			_OBS_28(window,_OBS_1[88],this,this.onResize),
			_OBS_28(window,_OBS_1[145],this,this.onResize),
	...
	{
		this.listeners=[
			_OBS_28(this.gantt=gantt,_OBS_1[87],this,this.onChange)
		];
		return true;
	...
	{
		var mapBody=this.gantt.getLayout(_OBS_1[86]);
	...
	_OBS_4(SFGanttCalDiv.prototype,{initialize: function(gantt)
	{
		...
		_OBS_4(div.style,{position:_OBS_1[180],padding:'0px',margin:'0px'});
		for(var i=0;i<this.calNum;i++)
		{
			var calDiv=doc.createElement("div");
			_OBS_4(calDiv.style,{position:_OBS_1[180],padding:'0px',margin:'0px',left:'0px'});
			div.appendChild(calDiv);
		}
		container.appendChild(div);
		this.listeners=[
			_OBS_28(gantt,_OBS_1[95],this,this.onResize),
			_OBS_28(gantt,_OBS_1[85],this,this.onResize),
			_OBS_28(gantt,_OBS_1[84],this,this.showCal),
			_OBS_28(gantt,_OBS_1[145],this,this.showCal)
		];
		this.onResize();
		return true;
	},onResize: function()
	...
	},addTimeSpans: function(startTime,endTime,drawObj,calDiv,position)
	{
		...
		while(sTime<endTime)
		{
			...
			_OBS_4(div.style,{position:_OBS_1[180],left:(sTime-drawObj.start)/drawObj.scale+"px",top:'0px',width:(eTime-sTime)/drawObj.scale+"px",height:height,fontSize:Math.floor(height*0.8)+"px",padding:'0px',lineHeight:height+"px",borderRight:_OBS_1[83]+this.gantt.borderColor,borderBottom:_OBS_1[83]+this.gantt.borderColor,textAlign:_OBS_1[82]});
	...
	_OBS_4(SFGanttCalendarControl.prototype,{initialize: function(gantt)
	{
		...
		var items={
			...
			Month:		new SFGanttCalendarItem(_OBS_1[89],	1,	formats.Month),
			Month1:		new SFGanttCalendarItem(_OBS_1[89],	1,	formats.Month1),
			Quarter:	new SFGanttCalendarItem(_OBS_1[89],	3,	formats.Quarter),
			Quarter1:	new SFGanttCalendarItem(_OBS_1[89],	3,	formats.Quarter1),
			Quarter2:	new SFGanttCalendarItem(_OBS_1[89],	6,	formats.Quarter2),
		...
		this.listeners=[
			_OBS_28(gantt,_OBS_1[95],this,this.onScaleChange),
			_OBS_28(gantt,_OBS_1[84],this,this.onScaleChange)
		];
		this.onScaleChange();
		return true;
	},getCalList: function()
	...
	_OBS_4(SFGanttChangeEventControl.prototype,{initialize: function(gantt)
	{
		...
		this.listeners=[
			_OBS_28(this.gantt=gantt,_OBS_1[95],this,this.onGanttInit)
		]
		return true;
	},onGanttInit: function()
	{
		var gantt=this.gantt;
		this.listeners=this.listeners.concat([
			_OBS_28(gantt.getData(),_OBS_1[144]+gantt.elementType.toLowerCase()+_OBS_1[153],this,this.onElementUpdate)
		]);
	...
	},onElementChange: function(element,changedFields)
	{
		...
		_OBS_35(this.gantt,gantt.elementType.toLowerCase()+_OBS_1[142],[element,changedFields]);
	}});
	...
	{
		if(!gantt.getLayout || gantt.disableCollapse || !gantt.getLayout(_OBS_1[81]) || !gantt.getLayout(_OBS_1[86]) || gantt.spaceWidth<4){return false;}
		var width=this.width=gantt.spaceWidth,doc=gantt.container.ownerDocument;
		var div=this.div=doc.createElement("div");
		
		_OBS_4(div.style,{position:_OBS_1[180],zIndex:200,top:'0px',width:width+"px",height:_OBS_1[178],backgroundColor:gantt.columnBarColor,borderLeft:_OBS_1[83]+gantt.borderColor,borderRight:_OBS_1[83]+gantt.borderColor});
		_OBS_11(div,_OBS_1[80]);
			var img=this.listColImg=gantt.createImage(_OBS_1[79],{position:[(width-5)/2,width]});
			_OBS_4(img.style,{position:_OBS_1[180],zIndex:200});
			_OBS_11(img,_OBS_1[184]);
			div.appendChild(img);

			var img=this.mapColImg=gantt.createImage(_OBS_1[78],{position:[(width-4)/2,width+10]});
			_OBS_4(img.style,{position:_OBS_1[180],zIndex:200});
			_OBS_11(img,_OBS_1[184]);
			div.appendChild(img);
		container.appendChild(div);
		if(gantt.setContextMenu){gantt.setContextMenu(div,function(menu){menu.type=_OBS_1[77];return true});}
		this.gantt=gantt;
		this.listeners=[
			_OBS_28(div,_OBS_1[173],this,this.onMouseDown),
			_OBS_28(gantt,_OBS_1[85],this,this.onLayoutChange)
		];
		return true;
	},onLayoutChange: function()
	{
		var gantt=this.gantt,listDiv=gantt.getLayout(_OBS_1[81]),mapDiv=gantt.getLayout(_OBS_1[86]);
		...
		gantt.setImageSrc(this.listColImg,listDiv.offsetWidth==0?_OBS_1[78]:_OBS_1[79]);
		gantt.setImageSrc(this.mapColImg,listDiv.offsetWidth==0?_OBS_1[79]:_OBS_1[78]);
	...
	{
		if(type==_OBS_1[170]){this.startColumn=this.gantt.listWidth*1}
	...
	_OBS_4(SFGanttDragResizeControl.prototype,{initialize: function(gantt,container)
	{
		...
		var resizeImg=this.div=gantt.createImage(_OBS_1[88]);
		_OBS_4(resizeImg.style,{position:_OBS_1[180],right:'0px',bottom:'0px',zIndex:200});
	...
	{
		var gantt=this.gantt;
		if(type==_OBS_1[170]){this.startSize=gantt.getViewSize();return;}
	...
	{
		if(type==_OBS_1[170]){this.startScale=this.gantt.getScale();}
		if(lp[0]>1)
		{
	...
	_OBS_4(SFGanttElementList.prototype,{initialize: function(gantt)
	{
		...
		var container=this.container=gantt.getLayout(this.mainList?"listId":_OBS_1[81]),doc=gantt.container.ownerDocument;
		if(!container){return false;}
		this.gantt=gantt;
		...
		var table=this.div=doc.createElement(_OBS_1[76]);
		_OBS_4(table,{bgColor:gantt.borderColor,border:0,cellSpacing:1,cellPadding:0});
		_OBS_4(table.style,{fontSize:'0px',position:_OBS_1[179],left:'-2px',top:'-3px',tableLayout:'fixed',zIndex:100});
		_OBS_40(table);
		
		var fRow=table.insertRow(-1),bgColor=this.bgColor;
		bgColor=bgColor?bgColor:_OBS_1[75];
		...
		_OBS_4(fCell.style,{overflowX:_OBS_1[181],fontSize:'0px',whiteSpace:whiteSpace});
		
		
		var div=doc.createElement("div");
		_OBS_4(div.style,{position:_OBS_1[179],left:'-1px',width:"1px"});
		fCell.appendChild(div);
		for(var j=0;j<fields.length;j++)
		{
			fCell=fRow.insertCell(-1);
			_OBS_4(fCell.style,{overflow:_OBS_1[181],fontSize:'0px',whiteSpace:whiteSpace});
		...
		_OBS_4(fCell.style,{overflow:_OBS_1[181],whiteSpace:whiteSpace});
		...
		var listeners=this.listeners=[
			_OBS_28(gantt,_OBS_1[88],this,this.onResize),
			_OBS_28(gantt,et+"inview",this,this.drawElement),
			_OBS_28(gantt,et+"outview",this,this.clearElement),
			_OBS_28(gantt,et+_OBS_1[142],this,this.updateElement),
			_OBS_28(table,_OBS_1[74],this,this.onTableClick),
			_OBS_28(table,_OBS_1[73],this,this.onTableDblClick)
		];
		if(gantt.setContextMenu){gantt.setContextMenu(table,function(menu){menu.type=_OBS_1[72];return true});}
		listeners.push(_OBS_28(table,_OBS_1[173],this,this.onTableMouseDown));
		
		if(this.mainList)
		{
			
			if(!this.disableAdjustLineHeight && !gantt.inline){listeners.push(_OBS_28(table,_OBS_1[172],this,this.onTableMouseOver));}
		}
		else
		{
			listeners.push(_OBS_28(gantt,_OBS_1[71],this,this.onHeadMove));
			listeners.push(_OBS_28(gantt,_OBS_1[70],this,this.onHeadResize));
		}
		if(this.disableDragOrder || gantt.inline){this.mainList=null;}
		if(gantt.setCursor){gantt.setCursor(table,this.mainList?_OBS_1[69]:'fieldedit.cur,default');}
		this.onResize();
		return true;
	},setViewTop: function()
	{
	...
	},applyRowStyle: function(row,element)
	{
		...
		var gantt=this.gantt,style=this.mainList?
			...
			(element.Selected?{backgroundColor:gantt.listFocusColor}:{backgroundColor:_OBS_1[75]});
		_OBS_4(row.style,style);
	},drawElement: function(element,viewIndex)
	{
		...
		for(var j=0;j<fields.length;j++)
		{
			...
			else
			{
				...
				_OBS_4(div.style,{width:_OBS_1[178],position:_OBS_1[179],top:'-1px',backgroundColor:_OBS_1[75],height:"1px",fontSize:'0px',overflow:_OBS_1[181]});
	...
	},onTableMouseOver: function(e)
	{
		...
		if(height<size || height>=gantt.getElementHeight(element)-size-1)
		{
			...
			if(t && t.canSetProperty(_OBS_1[127]))
			{
				if(gantt.setCursor){gantt.setCursor(this.div,'heightChange.cur,default');}
				this.dragMode=_OBS_1[68];
				return;
			}
		}
		if(gantt.setCursor){gantt.setCursor(this.div,element.Selected?_OBS_1[67]:_OBS_1[69]);}
		this.dragMode="";
	},onTableMouseDown: function(e)
	{
		...
		_OBS_35(this.gantt,this.elementType.toLowerCase()+_OBS_1[173],[element,e]);
		if(_OBS_39(e)!=1){return;}
		if(this.mainList)
		{
			if(this.dragMode==_OBS_1[68])
			{
			...
			new SFDragObject(row,_OBS_22(this,(this.dragMode==_OBS_1[68])?this.onItemHeightMove:this.onTableMove)).onMouseDown(e);
		}
	},onItemHeightMove: function(sp,lp,type)
	{
		var element=this.dragElement,gantt=this.gantt;
		if(type==_OBS_1[170]){this.startHeight=gantt.getElementHeight(element);return;}
		...
		else
		{
			...
			{
				element.setProperty(_OBS_1[127],height);
			}
		}
	...
	},showElementMoveFlag: function(element,dragElement,dir)
	{
		...
		var table=doc.createElement(_OBS_1[76]);
		table.cellSpacing=0;
		_OBS_4(table.style,{position:_OBS_1[180],width:_OBS_1[178],zIndex:200,height:'21px',left:'3px',top:height+"px"});
	...
	},updateElement: function(element,changedFields)
	{
		...
		if(!row){return;}
		if(_OBS_13(changedFields,_OBS_1[66]))
		{
			...
			{
				gantt.setCursor(row,selected?_OBS_1[67]:_OBS_1[69]);
			}
		}
		if(_OBS_13(changedFields,_OBS_1[129]))
		{
			this.applyRowStyle(row,element);
		}
		...
		if(_OBS_13(changedFields,_OBS_1[143]))
		{
			for(var i=0;i<this.fields.length;i++)
			{
	...
	},onTableDblClick: function(e)
	{
		...
		_OBS_35(this.gantt,this.elementType.toLowerCase()+_OBS_1[73],[element,_OBS_1[72],field.Name]);
	},onTableClick: function(e)
	{
		...
		var element=row._Element;
		_OBS_35(gantt,this.elementType.toLowerCase()+_OBS_1[74],[element,e]);
	...
	_OBS_4(SFGanttElementSelectControl.prototype,{initialize: function(gantt,container)
	{
		...
		_OBS_4(gantt,{
			...
			getSelectedElements:gantt[_OBS_1[65]+elementType+'s']=_OBS_22(this,this.getSelectedElements),
			setSelectedElement:gantt[_OBS_1[64]+elementType]=_OBS_22(this,this.setSelectedElement),
			clearSelectedElement:gantt[_OBS_1[63]+elementType]=_OBS_22(this,this.clearSelectedElement)
		});
		this.listeners=[
			_OBS_28(gantt,elementType.toLowerCase()+_OBS_1[173],this,this.onElementClick),
			_OBS_28(gantt,_OBS_1[95],this,this.onGanttInit)
		];
		return true;
	},onGanttInit: function()
	{
		...
		this.listeners=this.listeners.concat([
			_OBS_28(data,el+_OBS_1[152],this,this.onRegister),
			_OBS_28(data,el+_OBS_1[151],this,this.onUnRegister),
			_OBS_28(data,_OBS_1[144]+el+_OBS_1[142],this,this.onElementChange)
		]);
	...
	},onElementClick: function(element,e)
	{
		if(!e || _OBS_39(e)==2)
		{
			if(!element.Selected)
			{
				...
				element.setProperty(_OBS_1[66],true);
			}
		}
		else
		{
			...
			if(e.shiftKey && selectedElements[0])
			{
				...
				while(t)
				{
					...
					if(t){t.setProperty(_OBS_1[66],true);}
					if(t==element){return;}
				}
			}
			else if(e.ctrlKey)
			{
				element.setProperty(_OBS_1[66],!element.Selected);
			}
			else
			{
				this.clearSelectedElement();
	...
	},clearSelectedElement: function()
	{
		...
		while(element=elements.pop())
		{
			element.setProperty(_OBS_1[66],false);
		}
	},remove: function()
	{
		var gantt=this.gantt;
		...
		delete gantt[_OBS_1[65]+elementType+'s'];
		delete gantt[_OBS_1[64]+elementType];
	...
	_OBS_4(SFGanttFieldList.prototype,{initialize: function(gantt)
	{
		...
		if(!container){return false;}
		var fields=this.fields=_OBS_84(gantt.elementType,this.fieldNames),table=doc.createElement(_OBS_1[76]);
		_OBS_4(this,{container:container,gantt:gantt,div:table,fieldIndex:-1});
		_OBS_4(table,{bgColor:gantt.borderColor,border:0,cellSpacing:1,cellPadding:0});
		_OBS_4(table.style,{fontSize:'0px',height:(gantt.headHeight+2)+"px",left:'-2px',top:'-1px',position:_OBS_1[179],tableLayout:'fixed'});
		...
		for(var i=0;i<fields.length;i++)
		{
			...
			_OBS_4(cell.style,{overflow:_OBS_1[181],fontSize:gantt.fontSize+"px",whiteSpace:(document.compatMode?'nowrap':'pre')});
			fields[i].showHead(cell,this);
			this.widths.push(width);
		}
		container.appendChild(this.div);
		this.listeners=[
			_OBS_28(gantt,_OBS_1[95],this,this.setWidth),
			_OBS_59(table,_OBS_22(this,this.onDrag)),
			_OBS_28(table,_OBS_1[172],this,this.onMouseMove),
			_OBS_28(container,_OBS_1[92],this,this.onScroll)
		]
		return true;
	},onScroll: function()
	{
		
		_OBS_35(this.gantt,_OBS_1[71],[parseInt(this.div.style.left)]);
	},setWidth: function()
	{
		...
		_OBS_35(this.gantt,_OBS_1[70],[this.widths]);
	},onMouseMove: function(e)
	{
		...
		_OBS_11(this.div,index<0?_OBS_1[62]:_OBS_1[61]);
	},onDrag: function(sp,lp,type)
	{
		if(type==_OBS_1[170])
		{
			_OBS_11(this.div,_OBS_1[61]);
		...
		this.setWidth();
		if(type=="end"){_OBS_11(this.div,_OBS_1[62]);}
	}});
	...
	_OBS_4(SFGanttHelpLinkControl.prototype,{initialize: function(gantt)
	{
		...
		_OBS_4(helpDiv.style,{position:_OBS_1[180],backgroundColor:gantt.headBgColor,width:'16px',right:'0px',top:'0px',textAlign:_OBS_1[60],padding:'3px'});
		var helpLink=doc.createElement("a");
		_OBS_4(helpLink.style,{fontSize:'24px',color:_OBS_1[59],textDecoration:_OBS_1[165]});
		...
		_OBS_4(helpLink,{href:_OBS_1[58],target:'_blank'});
	...
	_OBS_4(SFGanttLayoutControl.prototype,{initialize: function(gantt,container)
	{
		...
		this.listeners=[
			_OBS_28(gantt,_OBS_1[95],this,this.onColumnResize),
			_OBS_28(gantt,"heightchange",this,this.onHeightChange),
			_OBS_28(gantt,_OBS_1[93],this,this.onGanttResize)
		]
		return true;
	...
	},createLayout: function(container)
	{
		...
		if(gantt.headHeight>0)
		{
			...
			_OBS_11(listHeadDiv,_OBS_1[62]);
			_OBS_40(headDiv);
			_OBS_4(headDiv.style,{position:_OBS_1[180],zIndex:100,left:'0px',top:'0px',width:_OBS_1[178],height:gantt.headHeight+"px",backgroundColor:gantt.headBgColor,borderBottom:_OBS_1[83]+gantt.borderColor});
				if(listWidth>0)
				{
					
					var listHeadDiv=panels.listHead=doc.createElement("div");
					_OBS_4(listHeadDiv.style,{position:_OBS_1[180],top:'0px',left:gantt.idCellWidth+"px",height:gantt.headHeight+"px",overflow:_OBS_1[181],borderLeft:_OBS_1[83]+gantt.borderColor});
				...
				if(mapWidth>0)
				{
					...
					_OBS_4(mapHeadDiv.style,{position:_OBS_1[180],top:'0px',height:gantt.headHeight+"px",top:'0px',left:'0px',width:_OBS_1[178],overflowX:_OBS_1[181],borderLeft:_OBS_1[83]+gantt.borderColor,borderRight:_OBS_1[83]+gantt.borderColor});
		...
		_OBS_4(bodyScrollDiv.style,{position:_OBS_1[180],zIndex:100,overflowY:_OBS_1[181],overflowX:_OBS_1[181],left:'0px',top:gantt.headHeight+1+"px",width:_OBS_1[178],height:(gantt.getContainer().offsetHeight-gantt.headHeight-gantt.footHeight)+"px"});
			...
			var bodyDiv=panels.body=doc.createElement("div");
				if(gantt.idCellWidth>0)
				{
					...
					_OBS_4(listIdDiv.style,{position:_OBS_1[180],width:gantt.idCellWidth+"px",overflow:_OBS_1[181]});
				...
				if(listWidth>0)
				{
					...
					_OBS_4(listBodyDiv.style,{position:_OBS_1[180],left:gantt.idCellWidth+"px",overflow:_OBS_1[181],borderLeft:_OBS_1[83]+gantt.borderColor,backgroundColor:_OBS_1[75]});
				...
				if(mapWidth>0)
				{
					...
					_OBS_4(mapBodyDiv.style,{position:_OBS_1[180],overflow:_OBS_1[181]});
		...
		if(gantt.footHeight>0)
		{
			...
			_OBS_4(footDiv.style,{position:_OBS_1[180],zIndex:100,left:'0px',bottom:'0px',width:_OBS_1[178],height:gantt.footHeight+"px",backgroundColor:gantt.bottomBgColor});
				if(listWidth>0)
				{
					
					var listFootDiv=panels.listFoot=doc.createElement("div");
					_OBS_4(listFootDiv.style,{position:_OBS_1[180],left:'0px',height:_OBS_1[178],bottom:'0px',fontSize:'0px',overflow:_OBS_1[181]});
				...
				if(mapWidth>0)
				{
					...
					_OBS_4(mapFootDiv.style,{position:_OBS_1[180],height:_OBS_1[178],bottom:'0px',fontSize:'0px',overflow:_OBS_1[181]});
	...
	},onColumnResize: function()
	{
		...
		var listDisplay=this.listHidden?_OBS_1[165]:"";
		...
		var mapDisplay=this.mapHidden?_OBS_1[165]:"";
	...
	_OBS_4(SFGanttLinksMap.prototype,{initialize: function(gantt)
	{
		...
		_OBS_4(linksDiv.style,{position:_OBS_1[180],fontSize:'0px',top:'-1px',left:'0px',zIndex:200});
		...
		this.listeners=[
			_OBS_28(gantt,_OBS_1[95],this,this.onInit),
			_OBS_28(gantt,_OBS_1[84],this,this.onScale),
			...
			_OBS_28(linksDiv,_OBS_1[74],this,this.onLinkClick),
			_OBS_28(linksDiv,_OBS_1[73],this,this.onLinkDblClick)
		];
	...
	},onInit: function()
	{
		...
		this.listeners=this.listeners.concat([
			_OBS_28(data,_OBS_1[155],this,this.drawLink),
			_OBS_28(data,_OBS_1[154],this,this.clearLink),
			_OBS_28(data,_OBS_1[99],this,this.updateLink),
			_OBS_28(data,_OBS_1[100],this,this.onScale),
			_OBS_28(data,_OBS_1[102],this,this.onScale)
		]);
		this.inited=true;
		this.refresh();
	},onScale: function()
	...
	},updateLinks: function(task,changedFields)
	{
		...
		for(var i=0;i<changedFields.length;i++)
		{
			...
			if(!redrawLink && (field==_OBS_1[140] || field==_OBS_1[141]))
			{
				redrawLink=true;
			}
		}
	...
	},drawLink: function(link)
	{
		...
		var dir,arrowSize,position,points=[],arrowStyle={},lineStyle={borderStyle:_OBS_1[168]},color=_OBS_1[59];
		...
		_OBS_4(linkImg.style,{position:_OBS_1[180],fontSize:'0px'});
	...
	},getLinkPaths: function(points,linkStyle,link)
	{
		...
		for(var i=1;i<points.length;i++)
		{
			...
			_OBS_4(div.style,{position:_OBS_1[180],fontSize:'0px',borderWidth:'0px'});
	...
	_OBS_4(SFGanttProgressLine.prototype,{initialize: function(gantt)
	{
		...
		_OBS_4(linesDiv.style,{position:_OBS_1[180],fontSize:'0px',top:'-1px',left:'0px',zIndex:190});
	...
	},drawLine: function(task)
	{
		...
		_OBS_4(vImg.style,{position:_OBS_1[180],fontSize:'0px',left:(ep[0]-Math.floor(vertexSize[0]/2))+"px",top:(ep[1]-Math.floor(vertexSize[1]/2))+"px"});
	...
	},updateLine: function(task,changedFields)
	{
		...
		for(var i=0;i<changedFields.length;i++)
		{
			...
			if(!redraw && (field==_OBS_1[140] || field==_OBS_1[141]  || field==_OBS_1[135]))
			{
				redraw=true;
			}
		}
	...
	_OBS_4(SFGanttListScrollNotice.prototype,{initialize: function(gantt,container)
	{
		...
		_OBS_4(div.style,{position:_OBS_1[180],zIndex:400,display:_OBS_1[165]});
		_OBS_4(div.style,this.divStyle);
		container.appendChild(div);
		this.listeners=[
			_OBS_28(gantt,_OBS_1[92],this,this.onScroll),
			_OBS_28(gantt,_OBS_1[93],this,this.onResize)
		];
		this.onResize();
		return true;
	...
	},onTime: function()
	{
		...
		if(!this.div.firstChild)
		{
			...
			for(var i=0;i<fieldLength;i++)
			{
				...
				var div=doc.createElement("div");
				_OBS_4(div.style,{position:_OBS_1[179],overflow:_OBS_1[181],width:"100px",height:"14px"});
				cell.appendChild(div);
			}
		}
		for(var i=0;i<fieldLength;i++)
	...
	_OBS_4(SFGanttLogoControl.prototype,{initialize: function(gantt)
	{
		...
		_OBS_4(logo.style,{position:_OBS_1[180]});
	...
	},getLogoTooltip: function(tooltip)
	{
		...
		div.innerHTML=_OBS_3("MbVH9VuHUveZQSihVswpCbskkkaVW5S3Vw8LVtvQQbF1KH4ypHF0wKS11L3SlEthgeg1hTX2QjfpxIQkwoJI7AKmw29eDZ");
	...
	_OBS_4(SFGanttContextMenuControl.prototype,{initialize: function(gantt)
	{
		...
		_OBS_4(table.style,{position:_OBS_1[180],zIndex:700});
		...
		this.listeners=[
			...
			_OBS_28(container,_OBS_1[173],this,this.onMouseDown),
			_OBS_28(table,_OBS_1[172],this,this.onItemMouseOver),
			_OBS_28(table,_OBS_1[173],this,this.onItemClick),
			_OBS_28(doc,_OBS_1[173],this,this.hidden)
		];
		return true;
	...
	{
		if(typeof(id)==_OBS_1[185]){id=id.id;}
		if(id)
		{
			for(var i=0;i<this.contextMenuItems.length;i++)
			{
	...
	},createItemContent: function()
	{
		...
		for(var i=0;i<this.items.length;i++)
		{
			...
			var row=this.div.insertRow(-1);
			var cell=row.insertCell(-1);
			_OBS_4(cell,{width:34,height:24,bgColor:'#F6F6F6',align:_OBS_1[82]});
			if(item.icon)
			{
			...
			_OBS_4(cell.style,{paddingLeft:'10px',paddingRight:'25px',fontSize:'13px',cursor:_OBS_1[62]});
	...
	_OBS_4(SFGanttDefaultMenuControl.prototype,{initialize: function(gantt,container)
	{
		...
		gantt.addContextMenuItem(
			function(ma){return (ma.type==_OBS_1[72] && ma.gantt.focusIntoView && ma.gantt.getFocusElement && ma.gantt.getFocusElement() && ma.gantt.getFocusElement().Start)?1:0},
		...
		gantt.addContextMenuItem(
			...
			function(ma){return (ma.type==_OBS_1[72] && ma.gantt.addTask && !ma.gantt.readOnly && !ma.gantt.disableAddTask)?1:0},
		...
		gantt.addContextMenuItem(
			function(ma){return (ma.type==_OBS_1[72] && ma.gantt.deleteTask && !ma.gantt.readOnly && !ma.gantt.disableDeleteTask && ma.gantt.getFocusElement && ma.gantt.getFocusElement() && ma.gantt.getFocusElement().elementType==_OBS_1[161])?1:0},
		...
		gantt.addContextMenuItem(
			function(ma){return (ma.type==_OBS_1[72] && ma.gantt.addTasksLinks && !ma.gantt.readOnly && !ma.gantt.disableAddLink && ma.gantt.getFocusElement && ma.gantt.getFocusElement() && ma.gantt.getFocusElement().elementType==_OBS_1[161])?1:0},
		...
		gantt.addContextMenuItem(
			function(ma){return (ma.type==_OBS_1[72] && ma.gantt.removeTasksLinks && !ma.gantt.readOnly && !ma.gantt.disableDeleteLink && ma.gantt.getFocusElement && ma.gantt.getFocusElement() && ma.gantt.getFocusElement().elementType==_OBS_1[161])?1:0},
		...
		gantt.addContextMenuItem(
			function(ma){return (ma.type==_OBS_1[72] && ma.gantt.upgradeSelectedTasks && !ma.gantt.readOnly && !ma.gantt.disableUpdateTask && ma.gantt.getFocusElement && ma.gantt.getFocusElement() && ma.gantt.getFocusElement().elementType==_OBS_1[161])?1:0},
		...
		gantt.addContextMenuItem(
			function(ma){return (ma.type==_OBS_1[72] && ma.gantt.degradeSelectedTasks && !ma.gantt.readOnly && !ma.gantt.disableUpdateTask && ma.gantt.getFocusElement && ma.gantt.getFocusElement() && ma.gantt.getFocusElement().elementType==_OBS_1[161])?1:0},
		...
		gantt.addContextMenuItem(
			function(ma){return (ma.type==_OBS_1[77] && ma.gantt.collapseChart && !ma.gantt.isChartShow())?1:0},
		...
		gantt.addContextMenuItem(
			function(ma){return (ma.type==_OBS_1[77] && ma.gantt.collapseList && !ma.gantt.isListShow())?1:0},
		...
		gantt.addContextMenuItem(
			...
			function(ma){window.open(_OBS_1[58]);},
			names.Help,
			null,
			'Help',
			901);
	...
	},openDialog: function(content,config)
	{
		...
		{
			var div=this.div=document.createElement("div");
			_OBS_4(div.style,{position:_OBS_1[180],overflow:_OBS_1[181],zIndex:990,border:_OBS_1[51],backgroundColor:_OBS_1[75]});
			var titleDiv=document.createElement("div");
			_OBS_4(titleDiv.style,{position:_OBS_1[179],borderBottom:_OBS_1[51],backgroundColor:_OBS_1[50],width:_OBS_1[178],height:'21px'});
			div.appendChild(titleDiv);
			var titleSpan=document.createElement("div");
			_OBS_4(titleSpan.style,{position:_OBS_1[179],width:_OBS_1[178],height:'16px',fontSize:"14px",fontWeight:'bolder',padding:'4px',paddingLeft:'10px',cursor:_OBS_1[145]});
			titleDiv.appendChild(titleSpan);
			var closeBtn=document.createElement("div")
			_OBS_4(closeBtn.style,{position:_OBS_1[180],right:'2px',top:'-8px',fontSize:'25px',backgroundColor:_OBS_1[50],cursor:_OBS_1[184]});
			closeBtn.appendChild(document.createTextNode("×"));
			div.appendChild(closeBtn);
			this.listeners=[_OBS_28(closeBtn,_OBS_1[74],this,this.closeDialog)];
			var contentDiv=document.createElement("div");
			_OBS_4(contentDiv.style,{position:_OBS_1[179],fontSize:'13px',margin:'5px'});
		...
		if(config.isModal)
		{
			...
			if(!maskDiv)
			{
				...
				_OBS_4(maskDiv.style,{position:_OBS_1[180],zIndex:950,backgroundColor:_OBS_1[59]});
				_OBS_12(maskDiv,0.7);
			}
	...
	},showPrintDialog: function()
	{
		...
		if(!contentDiv)
		{
			...
			this.listeners=[
				...
				_OBS_28(bt_submit,_OBS_1[74],this,this.onSubmit),
				_OBS_28(bt_cancel,_OBS_1[74],gantt,gantt.closeDialog)
			];
		}
	...
	},createPrintWindow: function()
	{
		...
		_OBS_4(iframe.style,{position:_OBS_1[180],width:"1px",height:"1px",left:'-2px',top:'-2px',visibility:_OBS_1[181]});
	...
	_OBS_4(SFGanttScrollControl.prototype,{initialize: function(gantt)
	{
		...
		container.style.overflowY=_OBS_1[92];
		if(!container){return false;}
		this.listeners=[
			_OBS_28(container,_OBS_1[92],this,this.onScroll)
		]
	...
	},onTime: function()
	{
		...
		_OBS_35(this.gantt,_OBS_1[92],[scrollTop,scrollObj]);
	...
	},onResize: function()
	{
		...
		this.div.style.display=width-height*2<=0?_OBS_1[165]:"";
	...
	},init: function(offsetWidth,scrollWidth,scrollLeft)
	{
		...
		this.barDiv.style.display=offsetWidth<scrollWidth?"":_OBS_1[165]
	...
	},scrollTo: function(scrollLeft,trigger)
	{
		...
		if(trigger!=false)
		{
			...
			_OBS_35(this,_OBS_1[92],[scrollLeft]);
		}
	},onMouseDown: function(e)
	{
		_OBS_26(e);
		...
		switch(e.target)
		{
			...
			case this.rightImg:
				...
				gantt.setImageSrc(e.target,"scroll_"+(flag?_OBS_1[60]:_OBS_1[96])+'1');
	...
	},initialize: function(gantt)
	{
		...
		this.listeners.push(_OBS_28(this,_OBS_1[92],this,this.onScroll));
		this.listeners.push(_OBS_28(gantt,_OBS_1[70],this,this.onResize));
		return true;
	},onResize: function()
	{
		if(!this.container){return;}
	...
	},onScroll: function(scrollLeft)
	{
		...
		_OBS_35(this.targetDiv,_OBS_1[92]);
	}});
	...
	},onResize: function()
	{
		if(!this.container){return;}
		SFGanttScrollerControl.prototype.onResize.apply(this,arguments);
		var width=this.gantt.getLayout(_OBS_1[86]).offsetWidth;
	...
	{
		this.listeners=[
			_OBS_28(gantt,_OBS_1[94],this,this.onBeforeResize)
		]
	...
	_OBS_4(SFGanttTasksMap.prototype,{initialize: function(gantt)
	{
		...
		_OBS_4(this.div.style,{position:_OBS_1[179],fontSize:'0px',left:'0px',top:'-1px',zIndex:100});
		var firstDiv=doc.createElement("div");
		_OBS_4(firstDiv.style,{position:_OBS_1[179],padding:'0px',margin:'0px',border:'0px'});
		tasksDiv.appendChild(firstDiv);
		gantt.getMapPanel().appendChild(tasksDiv);
		this.listeners=[
			_OBS_28(gantt,_OBS_1[95],this,this.onInitialize),
			_OBS_28(gantt,_OBS_1[84],this,this.onScale),
			...
			_OBS_28(tasksDiv,_OBS_1[73],this,this.onDblClick),
			_OBS_28(tasksDiv,_OBS_1[74],this,this.onClick),
			_OBS_28(tasksDiv,_OBS_1[173],this,this.onMouseDown)
		];
		if(gantt.setTooltip)
		{
	...
	{
		var doc=this.div.ownerDocument,table=doc.createElement(_OBS_1[76]);
		table.style.fontSize="12px";
		_OBS_4(table,{});
		var row=table.insertRow(-1);
		var cell=row.insertCell(-1);
	...
	},getLinkTooltipContent: function(link)
	{
		...
		var fields=_OBS_84(_OBS_1[159],this.linkAddNoticeFields.split(","));
	...
	},setScale: function(scale)
	{
		...
		_OBS_35(this.gantt,_OBS_1[84],[scale]);
		return true;
	...
	{
		if(!gantt.getLayout || !gantt.getStartTime || !gantt.getLayout(_OBS_1[86])){return false;}
		var container=this.div=gantt.container.ownerDocument.createElement("div");
		_OBS_4(container.style,{position:_OBS_1[179],left:'0px',top:'0px'});
		gantt.getLayout(_OBS_1[86]).appendChild(container);
		if(!container){return false;}
		this.gantt=gantt;
	...
	},onMove: function(sp,lp,type)
	{
		...
		_OBS_35(gantt,_OBS_1[92],[scrollTop]);
	...
	_OBS_4(SFGanttTimePanel.prototype,{initialize: function(gantt)
	{
		if(!gantt.getLayout || !gantt.getStartTime || !gantt.getLayout(_OBS_1[86])){return false;}
		var container=this.div=gantt.container.ownerDocument.createElement("div");
		_OBS_4(container.style,{position:_OBS_1[180],left:'0px',top:'0px',width:_OBS_1[178],height:_OBS_1[178],zIndex:10});
		...
		this.listeners=[
			_OBS_28(gantt,_OBS_1[95],this,this.onGanttInit),
			_OBS_28(gantt,_OBS_1[85],this,this.onTimeChange),
			_OBS_28(gantt,_OBS_1[32],this,this.onTimeChange),
			_OBS_28(gantt,_OBS_1[84],this,this.onTimeChange)
		];
		return true;
	...
	},onTimeChange: function(time)
	{
		...
		var gantt=this.gantt;
		this.div.style.left=-Math.round((gantt.getStartTime()-this.drawStart)/gantt.getScale()-_OBS_36(gantt.getLayout(_OBS_1[86]),gantt.getContainer())[0])+"px";
	...
	_OBS_4(SFGanttTimeLine.prototype,{initialize: function(gantt)
	{
		...
		_OBS_4(div.style,{position:_OBS_1[180],fontSize:'0px',left:'-1px',top:'0px',height:_OBS_1[178],zIndex:200});
		container.appendChild(div);
		this.listeners=[
			_OBS_28(gantt,_OBS_1[84],this,this.onMove)
		];
		if(this.dragable)
		{
			_OBS_11(div,_OBS_1[80]);
	...
	{
		if(type==_OBS_1[170]){this.dragStart=this.time.valueOf();}
	...
	_OBS_4(SFGanttTimeScrollNotice.prototype,{initialize: function(gantt,container)
	{
		...
		_OBS_4(this.div.style,{position:_OBS_1[180],zIndex:400,display:_OBS_1[165],left:"100px"});
		_OBS_4(this.div.style,this.divStyle);
		container.appendChild(this.div);
		this.listeners=[
			_OBS_28(gantt,_OBS_1[145],this,this.onMove),
			_OBS_28(gantt,_OBS_1[85],this,this.onResize)
		];
		return true;
	...
	{
		var mapDiv=this.gantt.getLayout(_OBS_1[86]);
	...
	_OBS_4(SFGanttTimeSegmentation.prototype,{initialize: function(gantt)
	{
		...
		var div=this.div=gantt.container.ownerDocument.createElement("div");
		_OBS_4(div.style,{position:_OBS_1[180],fontSize:'0px',left:'0px',top:'0px',height:_OBS_1[178],width:_OBS_1[178],zIndex:20});
		container.appendChild(div);
		this.listeners=[
			_OBS_28(gantt,_OBS_1[95],this,this.reDraw),
			_OBS_28(gantt,_OBS_1[85],this,this.reDraw),
			_OBS_28(gantt,_OBS_1[84],this,this.reDraw),
			_OBS_28(gantt,_OBS_1[145],this,this.reDraw)
		];
		this.reDraw();
		return true;
	},reDraw: function()
	...
	},addSegmentation: function(startTime,endTime,cal,calDiv,scale,position)
	{
		...
		while(sTime<endTime)
		{
			...
			var div=this.div.ownerDocument.createElement("div");
			_OBS_4(div,{sTime:sTime,eTime:eTime});
			_OBS_4(div.style,{position:_OBS_1[180],left:(sTime-this.drawStart)/scale+1+"px",top:'0px',width:'0px',height:_OBS_1[178],borderLeft:_OBS_1[31]});
			_OBS_4(div.style,this.lineStyle);
			if(position==-1)
			{
				if(lastAdd==null)
	...
	_OBS_4(SFGanttTooltipControl.prototype,{initialize: function(gantt)
	{
		...
		_OBS_4(div.style,{position:_OBS_1[180],zIndex:650});
		_OBS_4(div.style,this.divStyle);
	...
	_OBS_4(SFGanttDrawControl.prototype,{initialize: function(gantt)
	{
		...
		this.listeners=[_OBS_28(gantt,gantt.elementType.toLowerCase()+_OBS_1[142],this,this.onElementChange)]
		return true;
	...
	},onElementChange: function(element,changedFields)
	{
		...
		if(gantt.inline)
		{
			if(!_OBS_13(changedFields,_OBS_1[140]) && !_OBS_13(changedFields,_OBS_1[141])){return;}
		...
		if(_OBS_13(changedFields,_OBS_1[127]))
		{
	...
	_OBS_4(SFGanttViewItemsControl.prototype,{initialize: function(gantt)
	{
		...
		this.listeners=[
			_OBS_28(gantt,_OBS_1[95],this,this.onGanttInit),
			_OBS_28(gantt,_OBS_1[92],this,this.onScroll),
			_OBS_28(gantt,_OBS_1[93],this,this.showViewElements),
	...
	},onGanttInit: function()
	{
		...
		this.listeners=this.listeners.concat([
			_OBS_28(data,_OBS_1[144]+el+_OBS_1[145],this,this.onElementMove),
			_OBS_28(data,_OBS_1[144]+el+"add",this,this.onElementAdd),
			_OBS_28(data,_OBS_1[144]+el+_OBS_1[149],this,this.onElementDelete),
			_OBS_28(data,_OBS_1[144]+el+_OBS_1[142],this,this.onElementChange)
		]);
	...
	},setScrollTop: function(top)
	{
		...
		if(gantt.forPrint)
		{
			scrollDiv.firstChild.style.position=_OBS_1[179];
	...
	},inViewElement: function(element,index)
	{
		...
		_OBS_35(gantt,_OBS_1[87],[this.heightSpan]);
	...
	},onHeightChange: function(element,value,bValue)
	{
		...
		if(this.viewElements[0] && this.gantt.data.compareElement(element,this.viewElements[0])>=0)
		{
			...
			this.heightSpan[1]+=span;
			_OBS_35(this.gantt,_OBS_1[87],[this.heightSpan]);
		}
	...
	_OBS_4(SFGanttWorkingMask.prototype,{initialize: function(gantt)
	{
		...
		var div=this.div=gantt.container.ownerDocument.createElement("div");
		_OBS_4(div.style,{position:_OBS_1[180],fontSize:'0px',left:'0px',top:'0px',height:_OBS_1[178],width:_OBS_1[178],zIndex:10});
		container.appendChild(div);
		this.listeners=[
			_OBS_28(gantt,_OBS_1[95],this,this.onGanttInit),
			_OBS_28(gantt,_OBS_1[85],this,this.reDraw),
	...
	},addMask: function(startTime,endTime,cal,calDiv,scale,position)
	{
		...
		while(sTime<endTime)
		{
			...
			if(workTime[0]>=eTime.valueOf())
			{
				var div=doc.createElement("div");
				_OBS_4(div,{sTime:sTime,eTime:eTime});
				_OBS_4(div.style,{position:_OBS_1[180],left:(sTime-this.drawStart)/scale+1+"px",top:'0px',width:(eTime-sTime)/scale+"px",height:_OBS_1[178]});
	 ...
	 function SFGanttField()
	{
		...
		_OBS_4(this,{width:100,headText:"",headStyle:{textAlign:_OBS_1[82]},bodyStyle:{textAlign:_OBS_1[96]},inputStyle:{}});
		var obj=arguments[0];
		if(typeof(obj)!=_OBS_1[185])
		{
			var argu=arguments;
			obj={};
	...
	},bodyFunc: function(cell,element,list)
	{
		...
		value=(typeof(value)!=_OBS_1[175])?value:"";
	...
	},createInput: function(div)
	{
		...
		_OBS_4(input.style,{width:_OBS_1[178],height:_OBS_1[178],border:'solid 2px #000000',overflow:_OBS_1[181]});
		_OBS_31(input,_OBS_1[74],_OBS_27);
		_OBS_31(input,_OBS_1[171],_OBS_27);
		_OBS_31(input,_OBS_1[173],function(e)
		{
			_OBS_32(input.cml);
	...
	},inputFunc: function(cell,element,list)
	{
		...
		input.value=(typeof(value)!=_OBS_1[175])?value:"";
		...
		_OBS_31(input,_OBS_1[142],function()
		{
			element.setProperty(inputData,input.value);
		});
	 ...
	 function _OBS_85(type,name,field)
	{
	 ...
	 function _OBS_86(names){return _OBS_84(_OBS_1[161],names);}
	 function _OBS_87(names){return _OBS_84(_OBS_1[160],names);}
	 function _OBS_88(names){return _OBS_84(_OBS_1[159],names);}
	 function _OBS_89(name){return _OBS_83(_OBS_1[161],name);}
	 function _OBS_90(name){return _OBS_83(_OBS_1[160],name);}
	 function _OBS_91(name){return _OBS_83(_OBS_1[159],name);}
	 function _OBS_92(name,field){return _OBS_85(_OBS_1[161],name,field);}
	 function _OBS_93(name,field){return _OBS_85(_OBS_1[160],name,field);}
	 function _OBS_94(name,field){return _OBS_85(_OBS_1[159],name,field);}
	 function _OBS_95(name,width,headText,headFunc,bodyFunc,inputFunc,inputData,bodyData){_OBS_85(_OBS_1[161],name,new SFGanttField({width:width,headText:headText,headFunc:headFunc,bodyFunc:bodyFunc,inputFunc:inputFunc,inputData:inputData,bodyData:bodyData}));}
	 function _OBS_96()
	{
		...
		_OBS_92("UID",		new SFGanttField({width:36,bodyData:"UID",headText:names.UID,ReadOnly:true,bodyStyle:{textAlign:_OBS_1[82]}}));
		
		_OBS_92('ID',			new SFGanttField({width:36,bodyData:'ID',headText:names.ID,ReadOnly:true,bodyStyle:{textAlign:_OBS_1[82]}}))
		...
		_OBS_92(_OBS_1[138],	new SFGanttField({width:100,bodyData:_OBS_1[138],headText:names.OutlineNumber,ReadOnly:true}));
		...
		field.addIcon(function(element,gantt)
			{
				...
				if(gantt.setTooltip)
				{
					gantt.setTooltip(img,function(tooltip)
					{
						if(tooltip.bindObject==img){return false;}
						tooltip.bindObject=img;
						var str=_OBS_83(element.elementType,_OBS_1[134]).headText+": \""+element.Notes+"\"";
						tooltip.setContent(gantt.container.ownerDocument.createTextNode(str));
						return true;
					});
				}
		...
		_OBS_92(_OBS_1[140],		new SFGanttFieldDateTime({width:100,bodyData:_OBS_1[140],headText:names.Start,disableSummaryEdit:true}));
		
		_OBS_92(_OBS_1[141],		new SFGanttFieldDateTime({width:100,bodyData:_OBS_1[141],headText:names.Finish,disableSummaryEdit:true}));
		
		_OBS_92(_OBS_1[134],		new SFGanttFieldLongText({width:100,bodyData:_OBS_1[134],headText:names.Notes}));
		
		_OBS_92(_OBS_1[129],		new SFGanttFieldSelecter({width:120,bodyData:_OBS_1[129],headText:names.ClassName}));
		_OBS_89(_OBS_1[129]).getOptions=true?(function(element,list)
		{
			return {TaskNormal:_OBS_1[25],TaskImportant:'TaskImportant'};
		}):null;
		
		_OBS_92(_OBS_1[133],	new SFGanttFieldSelecter({width:120,bodyData:_OBS_1[133],headText:names.ConstraintType,options:window._SFGantt_config.SFGanttField.constraintTypes}));
		
		_OBS_92(_OBS_1[132],	new SFGanttFieldDateTime({width:100,bodyData:_OBS_1[132],headText:names.ConstraintDate}));
		
		_OBS_92(_OBS_1[126],		new SFGanttFieldBool({width:30,bodyData:_OBS_1[126],headText:names.Critical}));
		
		_OBS_92(_OBS_1[66],		new SFGanttFieldSelected({width:30,headText:names.Selected}));
		
		_OBS_92(_OBS_1[160],		new SFGanttField({width:100,bodyData:_OBS_1[160],headText:names.Resource,bodyFunc:function(cell,task,list)
			{
		...
		_OBS_92(_OBS_1[135],	new SFGanttFieldPercent({width:100,bodyData:_OBS_1[135],headText:names.PercentComplete}));
		
		_OBS_92(_OBS_1[131],	new SFGanttFieldDateTime({width:100,bodyData:_OBS_1[131],headText:names.ActualStart,disableSummaryEdit:true}));
		
		_OBS_92(_OBS_1[130],	new SFGanttFieldDateTime({width:100,bodyData:_OBS_1[130],headText:names.ActualFinish,disableSummaryEdit:true}));
		
		_OBS_92("ActualDuration",	new SFGanttFieldDuration({width:60,bodyData:'ActualStart,ActualFinish',headText:names.ActualDuration}));
		
		_OBS_92(_OBS_1[125],	new SFGanttFieldDateTime({width:100,bodyData:_OBS_1[125],headText:names.BaselineStart,disableSummaryEdit:true}));
		
		_OBS_92(_OBS_1[124],	new SFGanttFieldDateTime({width:100,bodyData:_OBS_1[124],headText:names.BaselineFinish,disableSummaryEdit:true}));
		...
		_OBS_93("UID",		new SFGanttField({width:36,bodyData:"UID",headText:names.UID,ReadOnly:true,bodyStyle:{textAlign:_OBS_1[82]}}));
		
		_OBS_93('ID',			new SFGanttField({width:36,bodyData:'ID',headText:names.ID,ReadOnly:true,bodyStyle:{textAlign:_OBS_1[82]}}))
		...
		_OBS_93(_OBS_1[138],	new SFGanttField({width:100,bodyData:_OBS_1[138],headText:names.OutlineNumber,ReadOnly:true}));
		...
		_OBS_93(_OBS_1[134],		new SFGanttFieldLongText({width:100,bodyData:_OBS_1[134],headText:names.Notes}));
		
		_OBS_93(_OBS_1[129],		new SFGanttFieldSelecter({width:120,bodyData:_OBS_1[129],headText:names.ClassName}));
		_OBS_90(_OBS_1[129]).getOptions=true?(function(element,list)
		{
			return {ResourceNormal:'ResourceNormal',ResourceImportant:'ResourceImportant'};
		}):null;
		
		_OBS_93(_OBS_1[126],		new SFGanttFieldBool({width:30,bodyData:_OBS_1[126],headText:names.Critical}));
		
		_OBS_93(_OBS_1[66],		new SFGanttFieldSelected({width:30,headText:names.Selected}));
		
		_OBS_93(_OBS_1[161],		new SFGanttField({width:100,bodyData:_OBS_1[160],headText:names.Resource,bodyFunc:function(cell,resource,list)
			{
		...
		_OBS_94(_OBS_1[121],		new SFGanttFieldSelecter({width:100,bodyData:_OBS_1[121],headText:names.LinkType,options:window._SFGantt_config.SFGanttField.linkTypes}));
		
		_OBS_94("FromTask",		new SFGanttFieldElement({width:100,bodyData:_OBS_1[114],headText:names.FromTask}));
		
		_OBS_94("ToTask",		new SFGanttFieldElement({width:100,bodyData:_OBS_1[115],headText:names.ToTask}));
	}
	...
	},inputFunc: function(cell,element,list)
	{
		...
		cell.appendChild(input);
		input.checked=!!value;
		_OBS_31(input,_OBS_1[74],function(e)
		{
			var btn=_OBS_39(e);
			if(btn && btn!=1){return;}
	...
	_OBS_4(SFGanttFieldPercent.prototype,{bodyFunc: function(cell,element,list)
	{
		...
		value=(typeof(value)!=_OBS_1[175])?value:0;
		value=Math.max(0,Math.min(value,100));
		var div=doc.createElement("div");
		_OBS_4(div.style,{position:_OBS_1[179],width:'90%',height:_OBS_1[178],backgroundColor:_OBS_1[75],border:_OBS_1[51],textAlign:_OBS_1[82]});
		cell.appendChild(div);
		var span=doc.createElement("div");
		_OBS_4(span.style,{position:_OBS_1[180],left:'0px',top:'0px',width:value+'%',height:_OBS_1[178],backgroundColor:_OBS_1[50],zIndex:2});
		div.appendChild(span);
		if(!this.ReadOnly)
		{
			var bar=doc.createElement("div");
			_OBS_4(bar.style,{position:_OBS_1[180],left:value+'%',top:'0px',width:'2px',height:_OBS_1[178],backgroundColor:'blue',zIndex:3});
			_OBS_11(bar,_OBS_1[80]);
			_OBS_59(bar,_OBS_22(this,this.onBarMove(element,div)),{container:div});
			div.appendChild(bar);
		}
		var text=doc.createElement("span");
		_OBS_4(text.style,{position:_OBS_1[179],zIndex:4});
	...
	},inputFunc: function(cell,element,list)
	{
		...
		input.checked=!!value;
		_OBS_31(input,_OBS_1[171],_OBS_27);
		_OBS_31(input,_OBS_1[173],_OBS_27);
		_OBS_31(input,_OBS_1[74],function(e)
		{
			_OBS_27(e);
			element.setProperty(_OBS_1[66],input.checked);
		});
	}});
	...
	_OBS_4(SFGanttFieldLongText.prototype,{inputFunc: function(cell,element,list)
	{
		...
		_OBS_4(input.style,{position:_OBS_1[180],left:position[0]+"px",top:position[1]+"px",width:(this.width-2)+"px",height:"100px",border:_OBS_1[51],overflow:_OBS_1[181],zIndex:100});
		_OBS_31(input,_OBS_1[74],_OBS_27);
		_OBS_31(input,_OBS_1[171],_OBS_27);
		_OBS_31(input,_OBS_1[173],function(e)
		{
	...
	},inputFunc: function(cell,element,list)
	{
		...
		value=(typeof(value)!=_OBS_1[175])?value:new Date();
	...
	_OBS_4(SFGanttFieldSelecter.prototype,{_getOptions: function(element,list)
	{
		...
		if(options)
		{
			if(!options.length)
			{
				...
				for(item in opts)
				{
					if(typeof(opts[item])==_OBS_1[182])
					{
	...
	},bodyFunc: function(cell,element,list)
	{
		...
		{
			if(typeof(options[i])==_OBS_1[185] && options[i].length>1 && options[i][0]==value)
			{
				cell.appendChild(doc.createTextNode(options[i][1]));
				return;
			}
			if(typeof(options[i])!=_OBS_1[185] && i==value)
			{
				cell.appendChild(doc.createTextNode(options[i]));
				return;
			}
		}
		cell.appendChild(doc.createTextNode((typeof(value)!=_OBS_1[175])?value:""));
	},inputFunc: function(cell,element,list)
	{
		...
		{
			var oi=options[i];
			if(typeof(oi)!=_OBS_1[185]){oi=[i,oi];}
	...
	_OBS_4(SFGanttFieldTreeName.prototype,{bodyFunc: function (cell,element,list)
	{
		...
		if(element.Summary && list && !(list.gantt.hideSummary && list.gantt.inline))
		{
			...
			cell.appendChild(img);
			_OBS_31(img,_OBS_1[74],function(e){_OBS_27(e);element.setProperty(_OBS_1[128],!element.Collapse);});
		}
	...
	},getCollapseImg: function(gantt,collapse)
	{
		...
		_OBS_4(img.style,{margin:"1px",cursor:_OBS_1[184]});
		return img;
	}});
	...
	_OBS_4(SFGanttFieldIcon.prototype,{headFunc: function(cell,list)
	{
		...
		_OBS_4(img.style,{position:_OBS_1[179]});
		cell.appendChild(img);
	},bodyFunc: function(cell,element,list)
	{
		cell.vAlign="middle";
	...
	},show: function(task,mapObj)
	{
		...
		_OBS_4(img.style,{position:_OBS_1[180],zIndex:150});
	...
	},getTooltip: function(task,mapObj,tooltip,e)
	{
		...
		if(tooltip.bindObject==task && tooltip.bindType==_OBS_1[161]){return false;}
	...
	},onUpdate: function(task,mapObj,changedFields)
	{
		...
		{
			if(_OBS_13(changedFields,_OBS_1[140]) || _OBS_13(changedFields,_OBS_1[141])){mapObj[this.name][1].style.left=(-Math.floor((control.taskHeight-1)/2)+(finish-start)/gantt.getScale())+"px"}
		}
	...
	},getTooltip: function(task,mapObj,tooltip,e)
	{
		if(e.target!=mapObj[this.name] || !this.control.taskNoticeFields){return false;}
		var control=this.control;
		if(tooltip && tooltip.bindObject==task && tooltip.bindType==_OBS_1[161]){return false;}
	...
	},onUpdate: function(task,mapObj,changedFields)
	{
		...
		{
			var style=div.style;
			if(_OBS_13(changedFields,_OBS_1[140]) || _OBS_13(changedFields,_OBS_1[141])){style.width=((finish-start)/gantt.getScale())+"px";}
		}
	},onScale: function(task,mapObj,scale)
	{
		var div=mapObj[this.name];
	...
	},onUpdate: function(task,mapObj,changedFields)
	{
		...
		else
		{
			...
			var style=div.style;
			if(_OBS_13(changedFields,_OBS_1[140]) || _OBS_13(changedFields,_OBS_1[141]))
			{
				div.style.left='0px';
	...
	},onMouseDown: function(task,mapObj,e)
	{
		...
		_OBS_35(mapObj[this.name],_OBS_1[74],[]);
	...
	},onMove: function(sp,lp,type)
	{
		...
		if(!control.dragType)
		{
			...
			if(span[0]==0 || span[1]/span[0]>2 && !control.gantt.readOnly && control.gantt.data.canAddLink(task) && !control.gantt.disableAddLink && !control.disableDragAddLink)
			{
				...
				mapObj[this.name].style.borderStyle=_OBS_1[164];
			}
			else if((span[1]==0 || span[0]/span[1]>2) && !gantt.readOnly && task.canSetProperty(_OBS_1[140]) && !control.gantt.disableUpdateTask && !control.disableDragMoveTask)
			{
				control.dragType=_OBS_1[140];
				if(gantt.getTooltip)
				{
					var tooltip=gantt.getTooltip();
					tooltip.setContent(control.getTaskTooltipContent(task,control.tooltipTitle.task,[_OBS_1[140],_OBS_1[141]]));
					gantt.getTooltip().setEnable(false);
		...
		if(control.dragType==_OBS_1[140])
		{
			...
			if(type!="end")
			{
				...
				if(left<=0 || left>gantt.getLayout(_OBS_1[86]).offsetWidth)
				{
				...
				if(gantt.getTooltip)
				{
					gantt.getTooltip().setContent(control.getTaskTooltipContent({Start:start,Finish:finish},control.tooltipTitle.task,[_OBS_1[140],_OBS_1[141]]));
					gantt.getTooltip().setEnable(false);
				}
			}
			else
			{
				...
				if(task.canSetProperty(_OBS_1[141],finish) && task.canSetProperty(_OBS_1[140],start))
				{
					task.setProperty(_OBS_1[141],finish);
					task.setProperty(_OBS_1[140],start);
		...
		else
		{
			...
			if(type!="end")
			{
				...
				graphics.setLineColor(_OBS_1[59])
				...
				if(lastLinkTask!=t)
				{
					if(t)
					{
						...
						{
							linkTaskMapObj[this.name].style.borderStyle=_OBS_1[164];
						}
					}
					if(lastLinkTask)
					{
						...
						if(linkTaskMapObj && linkTaskMapObj[this.name])
						{
							linkTaskMapObj[this.name].style.borderStyle=_OBS_1[168];
						}
					}
			...
			else
			{
				...
				mapObj[this.name].style.borderStyle=_OBS_1[168];
				if(gantt.getTooltip){gantt.getTooltip().setEnable(true);}
				delete control.dragType;
	...
	},getStyle: function(task,scale,key)
	{
		...
		var left=0,width=Math.max((finish-start)/scale,1),top=Math.ceil((gantt.itemHeight-gantt.fontSize)/2),align=_OBS_1[96],overflow=_OBS_1[181];
		switch(key)
		{
			case "Left":
				width=1000;
	...
	},show: function(task,mapObj,scale)
	{
		...
		scale=scale?scale:gantt.getScale();
		if(start>=finish || task.Summary || gantt.readOnly || !task.canSetProperty(_OBS_1[141])){return;}
	...
	},onUpdate: function(task,mapObj,changedFields)
	{
		...
		if(start>=finish || task.Summary || gantt.readOnly || !task.canSetProperty(_OBS_1[141]) || gantt.disableUpdateTask || control.disableDragResizeTask){this.remove(task,mapObj);return;}
		var div=mapObj[this.name];
		if(!div)
		{
			this.show(task,mapObj);
		...
		{
			var style=div.style;
			if(_OBS_13(changedFields,_OBS_1[140]) || _OBS_13(changedFields,_OBS_1[141])){style.left=((finish-start)/gantt.getScale()-Math.floor((control.taskHeight-1)/2))+"px";}
		}
	},onScale: function(task,mapObj,scale)
	{
		var div=mapObj[this.name];
	...
	},onResizeMove: function(sp,lp,type)
	{
		...
		if(type!="end")
		{
			...
			if(gantt.getTooltip)
			{
				gantt.getTooltip().setContent(control.getTaskTooltipContent({Start:task.Start,Finish:new Date(finish)},control.tooltipTitle.task,[_OBS_1[140],_OBS_1[141]]))
			}
		}
		else
		{
			if(!task.setProperty(_OBS_1[141],new Date(finish)))
			{
	...
	},show: function(task,mapObj)
	{
		...
		if(start>=finish || task.Summary || gantt.readOnly || !task.canSetProperty(_OBS_1[135])){return;}
	...
	},onUpdate: function(task,mapObj,changedFields)
	{
		...
		if(start>=finish || task.Summary || gantt.readOnly || !task.canSetProperty(_OBS_1[135]) || gantt.disableUpdateTask || control.disableDragChangePercent){this.remove(task,mapObj);return;}
		var div=mapObj[this.name];
		if(!div)
		{
			this.show(task,mapObj);
		...
		else
		{
			...
			if(_OBS_13(changedFields,_OBS_1[135]) || _OBS_13(changedFields,_OBS_1[140]) || _OBS_13(changedFields,_OBS_1[141]))
			{
	...
	},onPercentMove: function(sp,lp,type)
	{
		...
		if(type==_OBS_1[170])
		{
			...
			{
				var tooltip=gantt.getTooltip();
				tooltip.setContent(control.getTaskTooltipContent(task,control.tooltipTitle.progress,["name",_OBS_1[135]]));
		...
		if(type!="end")
		{
			...
			if(gantt.getTooltip)
			{
				gantt.getTooltip().setContent(control.getTaskTooltipContent({PercentComplete:percent,Name:task.Name},control.tooltipTitle.progress,["name",_OBS_1[135]]))
			}
		}
		else
		{
			...
			if(!task.setProperty(_OBS_1[135],p))
			{
				percent=task.getProperty(_OBS_1[135]);
				if(!percent){percent=0;}
				percentDiv.style.width=(finish-start)/gantt.getScale()*percent/100+"px";
			}
		}
	...
	},onUpdate: function(task,mapObj,changedFields)
	{
		...
		else
		{
			...
			var style=div.style;
			if(_OBS_13(changedFields,_OBS_1[125]) || _OBS_13(changedFields,_OBS_1[124]))
			{
				style.width=((finish-start)/gantt.getScale())+"px";
			}
			if(_OBS_13(changedFields,_OBS_1[140]) || _OBS_13(changedFields,_OBS_1[125]))
			{
